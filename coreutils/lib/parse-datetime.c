...
{
       0,   597,   597,   598,   602,   610,   612,   616,   621,   626,
     631,   636,   641,   646,   651,   655,   659,   666,   670,   674,
     679,   684,   689,   693,   698,   703,   710,   712,   716,   741,
     743,   753,   755,   757,   762,   767,   770,   772,   777,   782,
     787,   793,   802,   807,   840,   848,   856,   861,   867,   872,
     878,   882,   892,   894,   896,   901,   903,   905,   907,   909,
     911,   913,   916,   919,   921,   923,   925,   927,   929,   931,
     933,   935,   937,   939,   941,   943,   947,   949,   951,   954,
     956,   958,   963,   967,   967,   970,   971,   977,   978,   984,
     989,  1000,  1001
};
#endif
...
#line 1983 "parse-datetime.c"
    break;

  case 29: /* local_zone: tLOCAL_ZONE  */
#line 742 "parse-datetime.y"
      { pc->local_isdst = (yyvsp[0].intval); }
#line 1989 "parse-datetime.c"
    break;

  case 30: /* local_zone: tLOCAL_ZONE tDST  */
#line 744 "parse-datetime.y"
      {
        pc->local_isdst = 1;
        pc->dsts_seen++;
      }
#line 1998 "parse-datetime.c"
    break;

  case 31: /* zone: tZONE  */
#line 754 "parse-datetime.y"
      { pc->time_zone = (yyvsp[0].intval); }
#line 2004 "parse-datetime.c"
    break;
...
#line 2035 "parse-datetime.c"
    break;

  case 36: /* zone: tDAYZONE  */
#line 771 "parse-datetime.y"
...
#line 2131 "parse-datetime.c"
    break;

  case 44: /* date: tUNUMBER tMONTH tSNUMBER  */
#line 841 "parse-datetime.y"
      {
        /* E.g., 17-JUN-1992.  */
        pc->day = (yyvsp[-2].textintval).value;
...
#line 2164 "parse-datetime.c"
    break;

  case 47: /* date: tMONTH tUNUMBER ',' tUNUMBER  */
#line 862 "parse-datetime.y"
      {
